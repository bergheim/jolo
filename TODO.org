...
** TODO Plan: add `jolo clone <git-url> [dir]` command (devcontainer wrapper)
...
* TODO Worktree-in-container quick mode (=wt= command)
...
* TODO =jolo up --new --sync= fails when port already in use :jolo:bug:
:PROPERTIES:
:DATE: 2026-02-09
:END:
