...
* TODO Rename =jolo switch= to =jolo open=

=switch= implies toggling between things. =open= is what you're actually doing —
opening a running project. Rename the subcommand, update help text, README, AGENTS.md.
