...
class TestDeleteProjectByPath(unittest.TestCase):
    ...
    def test_delete_project_stops_and_removes_containers(
        self, mock_input, mock_subproc, mock_remove, mock_list,
        mock_find_containers, mock_runtime, mock_git_root
    ):
    ...
    def test_purge_removes_directories(
        self, mock_rmtree, mock_subproc, mock_remove, mock_list,
        mock_find_containers, mock_runtime, mock_git_root
    ):
...
class TestDeleteProjectWithWorktrees(unittest.TestCase):
    ...
    def test_yes_deletes_worktrees_too(
        self, mock_subproc, mock_remove_container, mock_remove_wt,
        mock_stop, mock_list, mock_find_containers,
        mock_runtime, mock_git_root
    ):
    ...
    def test_prompt_about_worktrees_without_yes(
        self, mock_input, mock_find_containers, mock_list,
        mock_runtime, mock_git_root
    ):
...
class TestDeleteInteractivePicker(unittest.TestCase):
    ...
    def test_picker_selects_worktree(
        self, mock_input, mock_remove, mock_stop, mock_which,
        mock_list, mock_containers, mock_git_root
    ):
