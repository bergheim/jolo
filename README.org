...
This project started as a way to isolate my Emacs config automatically to be able to easily try changes there. But Emacs just a git repo. So I made it work with any repo, and now Emacs is just there along for the ride. It is still a great fit for the project itself because that means you can use your favorite editor with your own config, and with packages like claude-code-ide or agent-shell.
