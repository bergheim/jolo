...
RUN echo 'set -g allow-passthrough on' > /etc/tmux.conf && \
    echo 'set -g terminal-features ",tmux-direct:sixel,tmux-direct:extkeys,xterm-256color:sixel,xterm-256color:extkeys,wezterm:sixel,wezterm:extkeys"' >> /etc/tmux.conf
